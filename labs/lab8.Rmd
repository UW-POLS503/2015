...
```{r}
rossoil <-read.csv("http://pols503.github.io/pols_503_sp15/data/rossoildata.csv", na.strings="")
democracy <- read.csv("http://pols503.github.io/pols_503_sp15/data/democracy.csv", header=TRUE, stringsAsFactors=FALSE, na.strings=".")
```
