...
from [Gapminder](http://gapminder.org).[^2]
This data was famously used in a TED talk by Hans Rosling.[^3]
...
[^3]: Hans Rosling. (2006, February). The Best Stats You've Ever Seen [Video file]. Retrieved from  <http://www.ted.com/talks/hans_rosling_shows_the_best_stats_you_ve_ever_seen>
