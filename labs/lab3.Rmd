...
For the sake of completeness, here's the equivalent "base R" way of pulling out (or indexing) a data frame to select rows or colums that meet certain criteria (you will likely see this in other's code or in help files etc as you explore resources on your ow):
