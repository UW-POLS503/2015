...
To give a better sense of what heteroskedasticity at various values of $\gamma_1$ correspond to, the following plot displays a scatterplot and a regression line for different values of $\gamma_1$:
```{r}
