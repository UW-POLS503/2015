...
- [gapminder.csv](data/gapminder.csv). csv version of the dataset `gapminder` in the [gapminder](http://cran.r-project.org/web/packages/gapminder/index.html) package. Data is originally from [gapminder](http://gapminder.org/data) and released under the Creative Commons Attribution 3.0 Unported license. csv file generated by [gapminder.R](data/gapminder.R).
