...
\begin{frame}
  ...
  \item represent statistical models in matrix algebra and compute basic matric operations
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics{images/Data_Science_VD.png}    
  \end{center}
...
\begin{frame}
  ...
  \item \href{http://www.nature.com/news/scientific-method-statistical-errors-1.14700}{NHST doubts}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics{images/Challenger_explosion.jpg}
  \end{center}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics{images/challenger2.png}
  \end{center}
...
\begin{frame}
  \begin{center}
    \includegraphics{images/Under_Construction.jpeg}    
  \end{center}
\end{frame}
