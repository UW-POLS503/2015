...
This problem uses [sprinters.csv](https://raw.githubusercontent.com/POLS503/pols_503_sp15/master/data/sprinters.csv) which contains the winning times from the \lnt{100} meter sprint in Olympic competitions going back to 1900.[^1]


The file `sprinters.csv`. 
...
a. In R, Create a matrix $X$ comprised of three columns: a column of
   ones, a columnmade of the variable year, and a column made up of
   ...
   b = (X' X)^{-1} X' y
   $$
   Report result of this calculation.
...
h. Do you trust the model’s predictions? Is there reason to trust the  prediction more than the 2156 prediction?
   Is any assumption of the model being abused or overworked to make this prediction?
   Hint: Try predicting the finishing times in the year 3000 C.E. and in -3000 B.C.E?
...
b. Create a scatter plot Hint: you can do this easily with `facet_wrap`.

## Problem 3

a. Create an R project for your analysis. Include all relevant data in that directory. Create an `.Rmd` file.
b. Describe your data and the variables in your data.
c. Summarize your data. Use both numerical and graphical summaries. 
