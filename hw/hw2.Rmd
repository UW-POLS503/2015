...
This problem uses [sprinters.csv](http://localhost:8000/data/sprinters.csv) which contains the winning times from the \lnt{100} meter sprint in Olympic competitions going back to 1900.[^1]
