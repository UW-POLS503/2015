...
```{r init,results='hide', echo = FALSE, message = FALSE}
set.seed(135125)
```
...
2. Do your analyses in an R markdown document.
...
Before running simulations  with `sim_lin_normal_truncated`,
...
The function `sim_lin_norm_ma1` has the same arguments as `sim_lin_norm` except for
